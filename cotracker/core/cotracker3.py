...
from cotracker.core.blocks import Mlp, BasicEncoder, Attention, AttnBlock, CrossAttnBlock
from cotracker.core.model_utils import sample_features5d, bilinear_sampler
from cotracker.core.embeddings import get_1d_sincos_pos_embed_from_grid
...
class EfficientUpdateFormer(nn.Module):
    ...
    def forward(self, input_tensor, mask=None, add_space_attn=True):
        print(f'efficient_update_former: {input_tensor.shape}')
...
class CoTrackerThreeOnline(CoTrackerThreeBase):
    ...
    def forward_window(
        ...
        for it in range(iters):
            ...
            for i in range(self.corr_levels):
                ...
                input = corr_volume.reshape(B * S * N, r * r * r * r)
                print(f'mlp: {input.shape}')
    ...
    def forward(
        ...
        for ind in indices:
            ...
            print(f'forward_window time: {time.time() - start}')
            S_trimmed = (
